/*
 * Mesmo codigo acrescido de metodo de identificacao em padrao Singleton
 */
...
public final class identificadorNota {
	private static identificadorNota instance = null;
	private identificadorNota() {
		//...
	}
	public static identificadorNota getInstance() {
		if (instance == null) {
			instance = new identificadorNota();
		}
		return instance;
	}
	//...
